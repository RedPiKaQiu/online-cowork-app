...
![Online Cowork 协作看板预览](docs/images/preview.png)

## 使用场景

- **多人轻量协作**：为活动筹备、内容共创、短期项目或小团队日常配合建一个共享看板。把链接发给参与者，大家即可共同补充、认领和推进事项。
- **个人项目管理**：把正在推进的想法、任务和待办集中在一个项目里。先放进「事项盒子」，再挑出当前最重要的事，完成后归档，既能当备忘，也能始终聚焦眼前。
