...
export type BoardState = ProjectSnapshot & { pending: string[]; error: string | null }
...
export function initialBoardState(snapshot: ProjectSnapshot): BoardState { return { ...snapshot, pending: [], error: null } }
